...
export function LanguageToggle() {
  ...
  const current = (i18n.resolvedLanguage as Language) in FLAGS ? (i18n.resolvedLanguage as Language) : "vi"
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="min-w-44">
        ...
        {SUPPORTED_LANGUAGES.map((lang) => (
          <DropdownMenuItem key={lang} className="cursor-pointer gap-2" onClick={() => changeLanguage(lang)}>
            <img src={FLAGS[lang]} alt="" aria-hidden="true" className="h-4 w-6 rounded-[2px] object-cover" />
