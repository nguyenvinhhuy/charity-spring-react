...
// Mirrors recharts' internal tooltip Payload<TValue, TName> shape, trimmed to the fields this component reads.
// graphicalItemId is required on recharts' own type (always populated by recharts itself at render time).
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  const css = Object.entries(THEMES)
    .map(([theme, selector]) => buildThemeCss(selector, id, theme as keyof typeof THEMES, colorConfig))
    .join("\n")
