...
/**
 * Renders the category sidebar and searchable accordion list of FAQs.
 *
 * @param faqs the full list of FAQ entries
 * @param categories the categories with counts, shown in the sidebar
 */
