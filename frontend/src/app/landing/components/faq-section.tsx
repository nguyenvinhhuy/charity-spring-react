...
const faqItems: FaqItem[] = [
  {
    value: 'item-1',
    question: 'How do I integrate Hương Sen components into my project?',
    answer:
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Everything you need to know about Hương Sen components, licensing, and integration. Still have questions? We're here to help!
          </p>
        </div>
