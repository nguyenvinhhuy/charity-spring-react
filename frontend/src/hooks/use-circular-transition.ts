...
/**
 * Manages the View Transitions-based circular reveal animation used when toggling the theme.
 *
 * @returns the transition trigger, the theme toggle handler, and the transition-in-progress check
 */
